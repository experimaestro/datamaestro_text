...
@Dataset(TipsterCollection, url=URL, id="aquaint.apw")
def apw(documents):
  """Associated Press (1998-2000)"""
  return { "path": documents }

@LinkFolder("documents", "NYT", ["%AQUAINT_DATADIR%"])
@Dataset(TipsterCollection, url=URL,id="aquaint.nyt")
def nyt(documents):
...
@Dataset(TipsterCollection, url=URL, id="aquaint.xie")
def xie(documents):
...
@Dataset(TipsterCollection, url=URL)
